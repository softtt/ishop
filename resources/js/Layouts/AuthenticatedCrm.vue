      ...
      <nav class="bg-white border-b border-gray-100">
          ...
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <button @click="goToFront" type="button"
                ...
                <button v-if="$page.props.isSuperAdmin" @click="goToAdmin" type="button"
                        class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-dark hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                  Admin
                </button>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
              ...
              <div class="ml-3 relative">
                <BreezeDropdown align="right" width="48">
                  ...
                  <template #content>
                    <BreezeDropdownLink :href="route('crm.logout')" method="post" as="button">
                      Log Out
                    </BreezeDropdownLink>
                  </template>
                </BreezeDropdown>
        ...
        <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
          <div class="pt-2 pb-3 space-y-1">
            <BreezeResponsiveNavLink :href="route('crm.dashboard')" :active="route().current('crm.dashboard')">
              Dashboard
            </BreezeResponsiveNavLink>
          </div>
          ...
          <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
              <BreezeResponsiveNavLink :href="route('crm.logout')" method="post" as="button">
                Log Out
              </BreezeResponsiveNavLink>
            </div>
          </div>
